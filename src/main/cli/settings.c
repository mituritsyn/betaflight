...
// PG_TIMECONFIG
    ...
    { PARAM_NAME_RPM_FILTER_HARMONIC_FADE_PERCENT,        VAR_UINT8 | MASTER_VALUE | MODE_ARRAY, .config.array.length = 3, PG_RPM_FILTER_CONFIG, offsetof(rpmFilterConfig_t, rpm_filter_harmonics_fade_percent) },
    { PARAM_NAME_RPM_FILTER_HARMONICS_Q,    VAR_UINT16 | MASTER_VALUE | MODE_ARRAY, .config.array.length = 3, PG_RPM_FILTER_CONFIG, offsetof(rpmFilterConfig_t, rpm_filter_harmonics_q) },
#endif
